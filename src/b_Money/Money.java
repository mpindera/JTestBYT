...
public class Money implements Comparable {
    ...
    public String toString() {
        return this.amount / 100 + "-" + this.currency.getRate();
    }
     ...
     */
    //check if UniversalValue is equal other UniversalValue
     ...
     */
    //cast to int because result can be double
    public Money add(Money other) {
        int newAmount = this.amount + (int) (other.universalValue() / this.currency.getRate());
    ...
    public int compareTo(Object other) {
        ...
        return Integer.compare(this.universalValue() - other1.universalValue(), 0);
    }
}